...
export class ProductRouter extends BaseRouter<ProductController> {
    ...
    routes(): void {
        ...
        this.router.put('/updateProduct', (req, res) => this.controller.updateProduct(req, res));
        this.router.delete('/deleteProduct', (req, res) => this.controller.deleteProduct(req, res));
    }
